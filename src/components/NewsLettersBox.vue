        ...
        <div class="relative px-6 py-10 bg-indigo-600 overflow-hidden sm:px-12 sm:py-20">
          ...
          <div class="relative">
            <div class="sm:text-center">
              <h2 class="text-3xl font-bold text-blue tracking-tight sm:text-4xl">
                Newsletter
              </h2>
              <p class="mt-6 mx-auto max-w-lg text-lg text-indigo-200">
                Abonnez-vous à notre bulletin d’information pour être informé(e) de nos
                dernières actualités.
              </p>
            </div>
            <form @submit.prevent="sendRequest" class="sm:justfy-start md:justify-center mt-8 block md:flex flex-wrap">
              <div class="mt-4 mr-0 md:mr-4">
                <label for="cta-email" class="sr-only">Email address</label>
                <div class="lg:w-full lg:min-w-[420px]">
                  <input id="cta-email" type="email" required v-model="email"
              ...
              <div class="mt-4">
                <button type="submit"
                  class="block w-full rounded-md px-5 py-3 bg-white text-base font-medium text-primary hover:bg-indigo-400 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-600 sm:px-10 flex justify-center"
                  :disabled="on_loading_request">
                  <div role="status" v-if="on_loading_request">
                    <svg aria-hidden="true" class="w-6 h-6 text-gray animate-spin fill-primary" viewBox="0 0 100 101"
