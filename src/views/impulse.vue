      ...
      <div class="py-20">
        ...
        >
          <div>
            ...
            <p class="my-3 leading-7 text-lg text-subtitlegray sm:my-4">
              Accélérateur du developpement des entreprises au Bénin, ImPULSE
              vous aide à vous structurer et vous développer pour gagner en
              performance.
            </p>
            <p class="mb-3 leading-7 text-lg text-subtitlegray">
              Cette initiative de la Chambre de Commerce et d’Industrie vise à
              apporter des réponses précises à des besoins spécifiques exprimés
              par les entreprises.
            </p>
            <p class="mb-3 leading-7 text-lg text-subtitlegray">
              Des conseillers d'entreprise, consultants et formateurs vous
              accompagnent dans la réalisation de diagnostics et de plans
              d'actions personnalisés, jusqu'à la mesure des résultats concrets.
            </p>
          </div>
        ...
        >
          ...
          <div>
            ...
            <p class="my-3 leading-7 text-lg text-subtitlegray sm:my-4">
              Porté par la chambre de commerce et d'industrie du BENIN, le
              service impulse rassemble de nombreux partenaires publics et
              parapublics chargés d’accompagner les entreprises.
            </p>
            <div
              class="
                mb-3
                leading-7
                text-lg text-subtitlegray
                flex
                items-center
                grid grid-flow-col
                auto-cols-max
            ...
            >
              ...
              <p>
                imPULSE identifiera le bon conseiller d'entreprise sur votre
                région économique;
              </p>
            </div>
            <div
            ...
            >
              ...
              <p>
                Le conseiller d'entreprise vous contacte directement pour vous
                aider sous 5 jours.
              </p>
            </div>
          </div>
