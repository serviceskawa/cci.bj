      ...
      <dl class="mt-6 space-y-6 divide-y divide-gray-200">
            ...
            <p class="text-md md:text-lg tracking-tight leading-7 text-subtitlegray">
              <a href="#" class="text-primary font-medium text-sm">
                <span class="underline">
                  Découvrez les différentes étapes et enjeux du lancement de votre projet entrepreneurial
        ...
        <Disclosure as="div" class="pt-6" v-slot="{ open }">
          ...
          <DisclosurePanel as="dd" class="mt-2 pr-12">
            <p class="text-md md:text-lg tracking-tight leading-7 text-subtitlegray">
              <a href="#" class="text-primary font-medium text-sm">
                <span class="underline">Découvrez les différentes étapes et enjeux du lancement de votre projet
