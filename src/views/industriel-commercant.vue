    ...
    <main class="pb-20">
        ...
        ">
            <div class="flex items-center w-full">
                ...
                tracking-tight
              ">
                        Vous êtes <br /> <span class="text-primary"> Commerçant <br> ou industriel </span>
                    </h1>
                    <p class="
                text-md
                md:text-lg
                ...
                mt-6
              ">
                        La Chambre de Commerce et d'Industrie du Bénin (CCI Bénin) <br /> offre gratuitement des
                        sessions sur l’arbitrage, <br />
        ...
        <div class="p-6 md:p-10 lg:p-12  xl:p-20 ">
            ...
            <p class="text-md
                ...
                relations d’affaires. Les modes alternatifs de règlement des litiges mis en œuvre par le CAMeC-CCIB sont
            ...
            <div class="py-16 flex flex-wrap grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
                <div class="card rounded-lg">
                    <div class=" p-5  md:p-10">
                        ...
                        <p class="text-lg tracking-tight leading-7 text-subtitlegray">
                            L’arbitrage désigne la technique visant à faire donner la solution d'une question,
                            intéressant
                            les rapports entre deux ou plusieurs personnes, par une ou plusieurs autres personnes -
                            l'arbitre ou les arbitres - lesquelles tiennent leurs pouvoirs d'une convention privée et
                ...
                <div class="card rounded-lg">
                    <div class=" p-5  md:p-10">
                        ...
                        <p class="text-lg tracking-tight leading-7 text-subtitlegray">
                            La médiation désigne la technique visant à faire donner la solution d'une question,
                            intéressant
                            les rapports entre deux ou plusieurs personnes, par une ou plusieurs autres personnes -
                            l'arbitre ou les arbitres - lesquelles tiennent leurs pouvoirs d'une convention privée et
                            statuent sur la base de cette convention, sans être investies de cette mission par l'État.
