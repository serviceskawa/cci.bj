    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-10 pt-10 pb-20">
      <div>
        ...
        >
          ...
          <div class="p-6 pb-12 shadow-lg mb-2 md:mb-0">
            ...
            <div class="mt-4">
              ...
              <p class="text-md text-light leading-5 text-subtitlegray">
                Ce programme s'adresse aux chefs et/ou hauts cadres d'entreprise
                désireux d'obtenir des conseils stratégiques, une orientation
                pour développer leurs affaires ou des réponses à leurs diverses
                préoccupations.
              </p>
            </div>
          </div>
          ...
          <div class="bg-grayCard grid grid-cols-1 md:grid-cols-2 gap-8 p-6">
            ...
            <div>
              ...
              <p
                ...
                "
              >
                Les experts de la Chambre de Commerce et d'Industries <br />
                du Bénin sont à votre disposition pour répondre à vos <br />
        ...
        <div class="pb-20">
          ...
          <p class="text-lg tracking-tight leading-7 text-subtitlegray mt-3">
            Bénéficiez des expertises venues d'institutions partenaires pour
            obtenir <br />
            une orientation dans divers domaines.
          </p>
          <div
            class="py-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"
          >
            <div class="rounded-lg bg-grayCard p-3">
              <svg
                width="48"
                height="48"
                viewBox="0 0 48 48"
              ...
              <p class="text-md leading-7 font-medium text-blue mt-4">
                Fiscalité
              </p>
            </div>
            <div class="rounded-lg bg-grayCard p-3">
        ...
        <div class="pb-20">
          <div class="px-6 bg-grayCard py-8">
            ...
            <p class="text-lg leading-7 text-subtitlegray mb-8">
              ...
              renseignements <br>  concernant le planning et le contenu des Journées
              Pays.
            </p>
            <div class="flex">
              <svg
...
.barner {
  background: linear-gradient(
    ...
    url("../assets/images/rdv.jpeg") !important;
