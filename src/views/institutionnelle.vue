      ...
      <div class="flex items-center w-full h-full">
        <div class="w-full lg:w-3/5 p-6 md:p-10 lg:p-12  xl:p-20 ">
          ...
          <p class="text-lg tracking-tight leading-7 text-subtitlegray mt-6">
            Découvrez les rapports et informations acualisées de la <br />
            Chambre de Commerce et d’Industrie sur les <br />
            entreprises et sociétés du Bénin.
          </p>
        </div>
        ...
        <div class="mb-4 pr-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-3 items-center">
            ...
            <div>
              ...
              <div class="text-base tracking-tight leading-6 text-subtitlegray">
                <b>Retrouvez</b> une entreprise en quelques clics grace au moteur de
                recherche integre
              </div>
            </div>
          </div>
            ...
            <div class="pr-2">
              ...
              <div class="text-base tracking-tight leading-6 text-subtitlegray">
                <b
                  ...
                  Services,</b
                >
                la CCl-Bénin met à disposition des acteurs économiques des statistiques de
                qualité et des informations crédibles pour les aider dans leurs prises de
                decision.
              </div>
            </div>
          </div>
        ...
        <div class="mb-4">
          ...
          <div class="flex justify-between items-center">
            <div>
              ...
              <div class="text-base tracking-tight leading-6 text-subtitlegray">
                <b>Formulez</b>
                vos demandes par messagerie electronique pour recevoir les chiffres clés,
                les dossiers économiques, les rapports et le baromètre de l’opinion des
                entreprises au Bénin, élaborés sur la base des données ici de nos
                collectes.
              </div>
              <div class="text-blue text-lg font-bold">
                Formulez vos demandes sur le info@ccib.bj
              </div>
            </div>
          </div>
        </div>
...
.right-section {
  background: linear-gradient(
    ...
    url("../assets/images/institut-cover.jpeg") !important;
