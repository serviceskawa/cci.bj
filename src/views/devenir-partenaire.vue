...
<template>
  <main>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-10 py-20">
      <div>
        <h6 class="text-blue mb-4">
          Remplissez ce formulaire et nous vous contacterons <br />
          ultérieument pour un rendez-vous physique.
        </h6>
        <div class="w-full lg:w-1/2">
          <form @submit.prevent="sumbitRequest">
            ...
            <div>
              <button
                type="submit"
                class="btn-light px-10 py-2 text-primary"
